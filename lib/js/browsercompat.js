function defaultBrowserIncompatibilityCallback(browser) {
...
export default class BrowserCompat {
    constructor() {
        this.compatibilityCheckers = [];
        this.error = '';
        this.caniuseRegex = null;
        this.useCanIuseRegex = false;
        this.userBrowserIncompatibilityCallback = null;
    }

    onBadBrowser(callback) {
    ...
    go(ua) {
        ...
        if ('' !== browser.error) {
            if (this.userBrowserIncompatibilityCallback && typeof this.userBrowserIncompatibilityCallback === 'function') {
                ...
                defaultBrowserIncompatibilityCallback(browser);
            }
        }
    }
